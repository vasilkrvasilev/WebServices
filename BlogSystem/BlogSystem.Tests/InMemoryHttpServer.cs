...
namespace BlogSystem.Tests
{
    class InMemoryHttpServer
    {
        ...
        public HttpResponseMessage CreateGetRequest(string requestUrl, string mediaType = "application/json", string sessionKey = null)
        {
            var url = requestUrl;
        ...
        public Task<HttpResponseMessage> CreateGetRequestAsync(string requestUrl, string mediaType = "application/json", string sessionKey = null)
        {
            var url = requestUrl;
            var request = new HttpRequestMessage();
            request.RequestUri = new Uri(baseUrl + url);
        ...
        public HttpResponseMessage CreatePostRequest(string requestUrl, object data, string mediaType = "application/json", string sessionKey = null)
        {
            var url = requestUrl;
            var request = new HttpRequestMessage();
            request.RequestUri = new Uri(baseUrl + url);
